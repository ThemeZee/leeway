...
class Leeway_Category_Posts_Grid_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __('Displays your posts from a selected category in a grid layout. Please use this widget ONLY in the Magazine Homepage widget area.', 'leeway')
		);
		parent::__construct('leeway_category_posts_grid', sprintf( __('Category Posts: Grid (%s)', 'leeway'), wp_get_theme()->Name ), $widget_ops);
