...
function leeway_customize_controls_js() {
	...
	wp_localize_script( 'leeway-customizer-controls', 'leeway_theme_links', array(
		...
		'themeURL'	=> esc_url( 'http://themezee.com/themes/leeway/?utm_source=customizer&utm_medium=textlink&utm_campaign=leeway&utm_content=theme-page' ),
		'themeLabel'	=> esc_html__( 'Theme Page', 'leeway' ),
		'docuURL'	=> esc_url( 'http://themezee.com/docs/leeway-documentation/?utm_source=customizer&utm_medium=textlink&utm_campaign=leeway&utm_content=documentation' ),
