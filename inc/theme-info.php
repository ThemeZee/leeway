 ...
 */
function leeway_theme_info_menu_link() {

	// Get theme details.
	$theme = wp_get_theme();

	add_theme_page(
		sprintf( esc_html__( 'Welcome to %1$s %2$s', 'leeway' ), $theme->get( 'Name' ), $theme->get( 'Version' ) ),
		esc_html__( 'Theme Info', 'leeway' ),
		'edit_theme_options',
		'leeway',
		'leeway_theme_info_page'
	);

}
add_action( 'admin_menu', 'leeway_theme_info_menu_link' );

/**
 * Display Theme Info page
 */
function leeway_theme_info_page() {
	...
	<div class="wrap theme-info-wrap">
		...
		<h1><?php printf( esc_html__( 'Welcome to %1$s %2$s', 'leeway' ), $theme->get( 'Name' ), $theme->get( 'Version' ) ); ?></h1>
		...
		<div class="important-links clearfix">
			<p><strong><?php esc_html_e( 'Theme Links', 'leeway' ); ?>:</strong>
				...
				<a href="http://preview.themezee.com/?demo=leeway&utm_source=theme-info&utm_campaign=leeway" target="_blank"><?php esc_html_e( 'Theme Demo', 'leeway' ); ?></a>
		...
		<div id="getting-started">
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						<h4><?php esc_html_e( 'Theme Options', 'leeway' ); ?></h4>
		...
		<div id="more-features">
			...
			<h3><?php esc_html_e( 'Get more features', 'leeway' ); ?></h3>
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						<h4><?php esc_html_e( 'Pro Version Add-on', 'leeway' ); ?></h4>
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						<h4><?php esc_html_e( 'Recommended Plugins', 'leeway' ); ?></h4>
		...
		<div id="theme-author">
			...
			<p><?php printf( esc_html__( '%1$s is proudly brought to you by %2$s. If you like this theme, %3$s :)', 'leeway' ),
				...
				'<a target="_blank" href="' . __( 'https://wordpress.org/support/theme/leeway/reviews/?filter=5', 'leeway' ) . '" title="' . esc_attr__( 'Review Leeway', 'leeway' ) . '">' . esc_html__( 'rate it', 'leeway' ) . '</a>'); ?>
			</p>
